 ...
 *https://www.rookiehpc.com/mpi/docs/mpi_request.php
 **/
...
int main(int argc, char *argv[]) {
  ...
  case RECEIVER: {
    ...
    printf("The MPI_Wait completed, which means the request (pointing to an "
           "MPI_Recv) is complete too (value received: %d).\n",
           received);
    break;
  }
  }
